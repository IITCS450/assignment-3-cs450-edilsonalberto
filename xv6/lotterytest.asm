...
int main(void) {
  ...
  // Child 1: 1 ticket
  pid1 = fork();
  11:	e8 b5 02 00 00       	call   2cb <fork>
  if(pid1 == 0){
  ...
  1d:	6a 01                	push   $0x1
  1f:	e8 4f 03 00 00       	call   373 <settickets>
  ...
  // Child 2: 3 tickets
  pid2 = fork();
  37:	e8 8f 02 00 00       	call   2cb <fork>
  if(pid2 == 0){
  3c:	85 c0                	test   %eax,%eax
  3e:	75 1d                	jne    5d <main+0x5d>
    settickets(3);
  40:	83 ec 0c             	sub    $0xc,%esp
  43:	6a 03                	push   $0x3
  45:	e8 29 03 00 00       	call   373 <settickets>
    for(int i = 0; i < 500000; i++) count2++;
    printf(1, "child2 (3 tickets): done\n");
  4a:	5a                   	pop    %edx
  4b:	59                   	pop    %ecx
  4c:	68 71 07 00 00       	push   $0x771
  51:	6a 01                	push   $0x1
  ...
  wait();
  5d:	e8 79 02 00 00       	call   2db <wait>
  wait();
  62:	e8 74 02 00 00       	call   2db <wait>
  printf(1, "lotterytest: done\n");
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 8b 07 00 00       	push   $0x78b
  6e:	6a 01                	push   $0x1
  70:	e8 bb 03 00 00       	call   430 <printf>
  exit();
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 a8 07 00 00 	jmp    *0x7a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 9e 07 00 00       	mov    $0x79e,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 a8 0a 00 00       	mov    0xaa8,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d a8 0a 00 00    	mov    0xaa8,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 a8 0a 00 00    	mov    0xaa8,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 a8 0a 00 00    	mov    %edx,0xaa8
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 a8 0a 00 00 ac 	movl   $0xaac,0xaa8
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf ac 0a 00 00       	mov    $0xaac,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 ac 0a 00 00 ac 	movl   $0xaac,0xaac
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 b0 0a 00 00 00 	movl   $0x0,0xab0
 742:	00 00 00 
    if(p->s.size >= nunits){
