...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 1b 7d 10 80 	movl   $0x80107d1b,(%esp)
...
801037ee:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 1;
801037f5:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->pid = nextpid++;
...
80103807:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010380d:	e8 9e 0d 00 00       	call   801045b0 <release>
...
8010382f:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103832:	c7 40 14 7f 5a 10 80 	movl   $0x80105a7f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103841:	e8 8a 0e 00 00       	call   801046d0 <memset>
...
801038e6:	68 00 79 10 80       	push   $0x80107900
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 4b 0b 00 00       	call   80104440 <initlock>
}
...
801039c3:	e8 a8 36 00 00       	call   80107070 <setupkvm>
...
801039e1:	e8 3a 33 00 00       	call   80106d20 <inituvm>
...
801039f3:	ff 73 1c             	pushl  0x1c(%ebx)
801039f6:	e8 d5 0c 00 00       	call   801046d0 <memset>
...
80103a4f:	68 30 79 10 80       	push   $0x80107930
80103a54:	50                   	push   %eax
80103a55:	e8 36 0e 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 39 79 10 80 	movl   $0x80107939,(%esp)
...
80103a93:	68 17 79 10 80       	push   $0x80107917
...
80103acb:	e8 40 31 00 00       	call   80106c10 <switchuvm>
  return 0;
...
80103aea:	e8 a1 33 00 00       	call   80106e90 <allocuvm>
...
80103b0a:	e8 b1 34 00 00       	call   80106fc0 <deallocuvm>
...
80103b58:	e8 03 36 00 00       	call   80107160 <copyuvm>
...
80103bd1:	e8 ba 0c 00 00       	call   80104890 <safestrcpy>
  pid = np->pid;
...
80103c84:	75 03                	jne    80103c89 <scheduler+0x49>
        total += p->tickets;
80103c86:	03 48 14             	add    0x14(%eax),%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c89:	83 e8 80             	sub    $0xffffff80,%eax
80103c8c:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103c91:	75 ed                	jne    80103c80 <scheduler+0x40>
    if(total == 0){
80103c93:	85 c9                	test   %ecx,%ecx
80103c95:	75 12                	jne    80103ca9 <scheduler+0x69>
      release(&ptable.lock);
80103c97:	83 ec 0c             	sub    $0xc,%esp
80103c9a:	68 20 1d 11 80       	push   $0x80111d20
80103c9f:	e8 0c 09 00 00       	call   801045b0 <release>
      continue;
80103ca4:	83 c4 10             	add    $0x10,%esp
80103ca7:	eb b7                	jmp    80103c60 <scheduler+0x20>
  lcg_state = lcg_state * 1664525 + 1013904223;
80103ca9:	69 05 08 a0 10 80 0d 	imul   $0x19660d,0x8010a008,%eax
80103cb0:	66 19 00 
  return lcg_state % max;
80103cb3:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb5:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
  lcg_state = lcg_state * 1664525 + 1013904223;
80103cba:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
80103cbf:	a3 08 a0 10 80       	mov    %eax,0x8010a008
  return lcg_state % max;
80103cc4:	f7 f1                	div    %ecx
    uint running_sum = 0;
80103cc6:	31 c0                	xor    %eax,%eax
80103cc8:	eb 11                	jmp    80103cdb <scheduler+0x9b>
80103cca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd0:	83 ef 80             	sub    $0xffffff80,%edi
80103cd3:	81 ff 54 3d 11 80    	cmp    $0x80113d54,%edi
80103cd9:	74 bc                	je     80103c97 <scheduler+0x57>
      if(p->state != RUNNABLE)
80103cdb:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cdf:	75 ef                	jne    80103cd0 <scheduler+0x90>
      running_sum += p->tickets;
80103ce1:	03 47 14             	add    0x14(%edi),%eax
      if(running_sum > winner)
80103ce4:	39 d0                	cmp    %edx,%eax
80103ce6:	76 e8                	jbe    80103cd0 <scheduler+0x90>
    if(p == &ptable.proc[NPROC] || p->state != RUNNABLE){
80103ce8:	81 ff 54 3d 11 80    	cmp    $0x80113d54,%edi
80103cee:	74 a7                	je     80103c97 <scheduler+0x57>
    switchuvm(p);
80103cf0:	83 ec 0c             	sub    $0xc,%esp
    c->proc = p;
80103cf3:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    switchuvm(p);
80103cf9:	57                   	push   %edi
80103cfa:	e8 11 2f 00 00       	call   80106c10 <switchuvm>
    swtch(&(c->scheduler), p->context);
80103cff:	58                   	pop    %eax
80103d00:	5a                   	pop    %edx
80103d01:	ff 77 20             	pushl  0x20(%edi)
80103d04:	56                   	push   %esi
    p->state = RUNNING;
80103d05:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
    swtch(&(c->scheduler), p->context);
80103d0c:	e8 da 0b 00 00       	call   801048eb <swtch>
    switchkvm();
80103d11:	e8 ea 2e 00 00       	call   80106c00 <switchkvm>
    c->proc = 0;
80103d16:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d1d:	00 00 00 
    release(&ptable.lock);
80103d20:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d27:	e8 84 08 00 00       	call   801045b0 <release>
80103d2c:	83 c4 10             	add    $0x10,%esp
80103d2f:	e9 2c ff ff ff       	jmp    80103c60 <scheduler+0x20>
...
80103e09:	e8 72 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103e0e:	39 05 54 3d 11 80    	cmp    %eax,0x80113d54
80103e14:	0f 84 fd 00 00 00    	je     80103f17 <exit+0x117>
80103e1a:	89 c3                	mov    %eax,%ebx
80103e1c:	8d 70 2c             	lea    0x2c(%eax),%esi
80103e1f:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103ebb:	81 fa 54 3d 11 80    	cmp    $0x80113d54,%edx
80103ec1:	74 3b                	je     80103efe <exit+0xfe>
    if(p->parent == curproc){
80103ec3:	39 5a 18             	cmp    %ebx,0x18(%edx)
80103ec6:	75 f0                	jne    80103eb8 <exit+0xb8>
      if(p->state == ZOMBIE)
80103ec8:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103ecc:	89 4a 18             	mov    %ecx,0x18(%edx)
      if(p->state == ZOMBIE)
...
80103f0d:	68 88 79 10 80       	push   $0x80107988
80103f12:	e8 69 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f17:	83 ec 0c             	sub    $0xc,%esp
80103f1a:	68 7b 79 10 80       	push   $0x8010797b
...
80103f6b:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80103f71:	74 1b                	je     80103f8e <wait+0x5e>
      if(p->parent != curproc)
80103f73:	39 73 18             	cmp    %esi,0x18(%ebx)
...
80103fa1:	e8 1a 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103fa6:	e8 55 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80103ff9:	e8 f2 2f 00 00       	call   80106ff0 <freevm>
        p->pid = 0;
80103ffe:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104005:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010400c:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80104010:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
...
80104050:	68 94 79 10 80       	push   $0x80107994
...
80104071:	e8 4a 04 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80104076:	e8 85 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
801040bf:	e8 fc 03 00 00       	call   801044c0 <pushcli>
  c = mycpu();
801040c4:	e8 37 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
...
80104159:	68 9a 79 10 80       	push   $0x8010799a
8010415e:	e8 1d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104163:	83 ec 0c             	sub    $0xc,%esp
80104166:	68 94 79 10 80       	push   $0x80107994
...
801041a0:	3b 58 24             	cmp    0x24(%eax),%ebx
801041a3:	75 eb                	jne    80104190 <wakeup+0x20>
      p->state = RUNNABLE;
801041a5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ac:	83 e8 80             	sub    $0xffffff80,%eax
801041af:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
801041f3:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
...
801041ff:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80104203:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
80104259:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
801042ed:	68 01 74 10 80       	push   $0x80107401
...
8010431a:	68 24 7a 10 80       	push   $0x80107a24
...
80104383:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104389:	e8 f2 f5 ff ff       	call   80103980 <myproc>
...
8010442b:	e8 50 f5 ff ff       	call   80103980 <myproc>
...
80104555:	68 2f 7a 10 80       	push   $0x80107a2f
8010455a:	e8 21 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 46 7a 10 80       	push   $0x80107a46
...
801045cb:	68 4d 7a 10 80       	push   $0x80107a4d
...
8010464c:	e8 af f2 ff ff       	call   80103900 <mycpu>
...
801046c0:	68 55 7a 10 80       	push   $0x80107a55
...
80104995:	e8 e6 ef ff ff       	call   80103980 <myproc>
8010499a:	8b 55 08             	mov    0x8(%ebp),%edx
8010499d:	8b 40 1c             	mov    0x1c(%eax),%eax
801049a0:	8b 40 44             	mov    0x44(%eax),%eax
801049a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049a6:	e8 d5 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049e6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801049e9:	e8 92 ef ff ff       	call   80103980 <myproc>
801049ee:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049f0:	e8 8b ef ff ff       	call   80103980 <myproc>
801049f5:	8b 55 08             	mov    0x8(%ebp),%edx
801049f8:	8b 40 1c             	mov    0x1c(%eax),%eax
801049fb:	8b 40 44             	mov    0x44(%eax),%eax
801049fe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a01:	e8 7a ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a54:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a55:	e8 26 ef ff ff       	call   80103980 <myproc>
80104a5a:	8b 55 08             	mov    0x8(%ebp),%edx
80104a5d:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a60:	8b 40 44             	mov    0x44(%eax),%eax
80104a63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a66:	e8 15 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a7b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104a7e:	e8 fd ee ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104ad4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ad7:	e8 a4 ee ff ff       	call   80103980 <myproc>
80104adc:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104ade:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104aec:	8b 14 85 80 7a 10 80 	mov    -0x7fef8580(,%eax,4),%edx
...
80104b10:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104b11:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104b14:	50                   	push   %eax
80104b15:	ff 73 10             	pushl  0x10(%ebx)
80104b18:	68 5d 7a 10 80       	push   $0x80107a5d
80104b1d:	e8 7e bb ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104b22:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104c74:	68 f8 7a 10 80       	push   $0x80107af8
...
80104c8c:	68 f7 7a 10 80       	push   $0x80107af7
...
80104ca1:	68 eb 7a 10 80       	push   $0x80107aeb
...
80104cbf:	68 fa 7a 10 80       	push   $0x80107afa
80104cc4:	e8 b7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cc9:	83 ec 0c             	sub    $0xc,%esp
80104ccc:	68 dc 7a 10 80       	push   $0x80107adc
...
80104d08:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104d20:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104d40:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104d43:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104d88:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104e00:	e8 7b eb ff ff       	call   80103980 <myproc>
80104e05:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e08:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104e3d:	ff 75 f0             	pushl  -0x10(%ebp)
80104e40:	ff 75 f4             	pushl  -0xc(%ebp)
...
80104e8b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
80104e8f:	85 f6                	test   %esi,%esi
80104e91:	74 25                	je     80104eb8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e93:	e8 e8 ea ff ff       	call   80103980 <myproc>
  fileclose(f);
80104e98:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104e9b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80104ea2:	00 
  fileclose(f);
...
80104f62:	0f 88 e2 00 00 00    	js     8010504a <sys_link+0x11a>
  begin_op();
80104f68:	e8 f3 dd ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
...
80104ffb:	e8 b0 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105000:	e8 cb dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010503d:	e8 ce c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105042:	e8 89 dd ff ff       	call   80102dd0 <end_op>
  return -1;
...
80105099:	0f 88 7a 01 00 00    	js     80105219 <sys_unlink+0x199>
  begin_op();
8010509f:	e8 bc dc ff ff       	call   80102d60 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
801050cd:	58                   	pop    %eax
801050ce:	5a                   	pop    %edx
801050cf:	68 f8 7a 10 80       	push   $0x80107af8
...
801050e8:	68 f7 7a 10 80       	push   $0x80107af7
...
80105187:	e8 84 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010518c:	e8 3f dc ff ff       	call   80102dd0 <end_op>
  return 0;
...
801051e3:	ff 75 b4             	pushl  -0x4c(%ebp)
801051e6:	e8 25 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
801051eb:	e8 e0 db ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010521e:	e9 73 ff ff ff       	jmp    80105196 <sys_unlink+0x116>
    end_op();
80105223:	e8 a8 db ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105265:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
{
...
80105275:	e8 d6 f7 ff ff       	call   80104a50 <argstr>
8010527a:	83 c4 10             	add    $0x10,%esp
8010527d:	85 c0                	test   %eax,%eax
8010527f:	0f 88 db 00 00 00    	js     80105360 <sys_open+0x100>
80105285:	83 ec 08             	sub    $0x8,%esp
80105288:	8d 85 64 ff ff ff    	lea    -0x9c(%ebp),%eax
8010528e:	50                   	push   %eax
8010528f:	6a 01                	push   $0x1
80105291:	e8 fa f6 ff ff       	call   80104990 <argint>
80105296:	83 c4 10             	add    $0x10,%esp
80105299:	85 c0                	test   %eax,%eax
8010529b:	0f 88 bf 00 00 00    	js     80105360 <sys_open+0x100>
    return -1;

  begin_op();
801052a1:	e8 ba da ff ff       	call   80102d60 <begin_op>

  if(omode & O_CREATE){
801052a6:	f6 85 65 ff ff ff 02 	testb  $0x2,-0x9b(%ebp)
801052ad:	0f 85 bd 00 00 00    	jne    80105370 <sys_open+0x110>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801052b6:	ff b5 60 ff ff ff    	pushl  -0xa0(%ebp)
801052bc:	e8 df cd ff ff       	call   801020a0 <namei>
801052c1:	83 c4 10             	add    $0x10,%esp
801052c4:	89 c6                	mov    %eax,%esi
801052c6:	85 c0                	test   %eax,%eax
801052c8:	0f 84 72 01 00 00    	je     80105440 <sys_open+0x1e0>
      end_op();
      return -1;
    }
    ilock(ip);
...
801052d2:	e8 a9 c4 ff ff       	call   80101780 <ilock>

    // Follow symbolic links (up to depth 10)
    for(depth = 0; ip->type == T_SYMLINK && depth < 10; depth++){
801052d7:	0f b7 46 50          	movzwl 0x50(%esi),%eax
801052db:	83 c4 10             	add    $0x10,%esp
801052de:	66 83 f8 04          	cmp    $0x4,%ax
801052e2:	0f 85 38 01 00 00    	jne    80105420 <sys_open+0x1c0>
801052e8:	bb 0a 00 00 00       	mov    $0xa,%ebx
801052ed:	8d bd 68 ff ff ff    	lea    -0x98(%ebp),%edi
801052f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801052f7:	90                   	nop
      int n = readi(ip, target, 0, sizeof(target) - 1);
801052f8:	6a 7f                	push   $0x7f
801052fa:	6a 00                	push   $0x0
801052fc:	57                   	push   %edi
801052fd:	56                   	push   %esi
801052fe:	e8 8d c7 ff ff       	call   80101a90 <readi>
      if(n <= 0){
80105303:	83 c4 10             	add    $0x10,%esp
80105306:	85 c0                	test   %eax,%eax
80105308:	7e 45                	jle    8010534f <sys_open+0xef>
        iunlockput(ip);
        end_op();
        return -1;
      }
...
8010530a:	83 ec 0c             	sub    $0xc,%esp
      target[n] = '\0';
8010530d:	c6 84 05 68 ff ff ff 	movb   $0x0,-0x98(%ebp,%eax,1)
80105314:	00 
      iunlockput(ip);
80105315:	56                   	push   %esi
80105316:	e8 f5 c6 ff ff       	call   80101a10 <iunlockput>
      if((ip = namei(target)) == 0){
8010531b:	89 3c 24             	mov    %edi,(%esp)
8010531e:	e8 7d cd ff ff       	call   801020a0 <namei>
80105323:	83 c4 10             	add    $0x10,%esp
80105326:	89 c6                	mov    %eax,%esi
80105328:	85 c0                	test   %eax,%eax
8010532a:	0f 84 10 01 00 00    	je     80105440 <sys_open+0x1e0>
        end_op();
        return -1;
      }
      ilock(ip);
...
80105334:	e8 47 c4 ff ff       	call   80101780 <ilock>
    for(depth = 0; ip->type == T_SYMLINK && depth < 10; depth++){
80105339:	0f b7 46 50          	movzwl 0x50(%esi),%eax
8010533d:	83 c4 10             	add    $0x10,%esp
80105340:	66 83 f8 04          	cmp    $0x4,%ax
80105344:	0f 85 d6 00 00 00    	jne    80105420 <sys_open+0x1c0>
8010534a:	83 eb 01             	sub    $0x1,%ebx
8010534d:	75 a9                	jne    801052f8 <sys_open+0x98>
    }

    // If still a symlink, we hit the depth limit (cycle)
    if(ip->type == T_SYMLINK){
      iunlockput(ip);
8010534f:	83 ec 0c             	sub    $0xc,%esp
80105352:	56                   	push   %esi
80105353:	e8 b8 c6 ff ff       	call   80101a10 <iunlockput>
      end_op();
80105358:	e8 73 da ff ff       	call   80102dd0 <end_op>
      return -1;
...
80105373:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105379:	31 c9                	xor    %ecx,%ecx
8010537b:	ba 02 00 00 00       	mov    $0x2,%edx
80105380:	6a 00                	push   $0x0
80105382:	e8 b9 f7 ff ff       	call   80104b40 <create>
    if(ip == 0){
...
8010538e:	0f 84 ac 00 00 00    	je     80105440 <sys_open+0x1e0>
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105394:	e8 97 ba ff ff       	call   80100e30 <filealloc>
80105399:	89 c7                	mov    %eax,%edi
8010539b:	85 c0                	test   %eax,%eax
8010539d:	74 b0                	je     8010534f <sys_open+0xef>
  struct proc *curproc = myproc();
8010539f:	e8 dc e5 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801053a4:	31 db                	xor    %ebx,%ebx
801053a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801053ad:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd] == 0){
801053b0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
801053b4:	85 d2                	test   %edx,%edx
801053b6:	74 18                	je     801053d0 <sys_open+0x170>
  for(fd = 0; fd < NOFILE; fd++){
801053b8:	83 c3 01             	add    $0x1,%ebx
801053bb:	83 fb 10             	cmp    $0x10,%ebx
801053be:	75 f0                	jne    801053b0 <sys_open+0x150>
      fileclose(f);
...
801053cc:	eb 81                	jmp    8010534f <sys_open+0xef>
801053ce:	66 90                	xchg   %ax,%ax
  iunlock(ip);
801053d0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801053d3:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
801053e2:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->readable = !(omode & O_WRONLY);
801053e8:	8b 95 64 ff ff ff    	mov    -0x9c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801053ee:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801053f1:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
801053f4:	89 d0                	mov    %edx,%eax
  f->off = 0;
801053f6:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801053fd:	f7 d0                	not    %eax
801053ff:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105402:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
80105405:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105408:	0f 95 47 09          	setne  0x9(%edi)
}
...
80105420:	66 83 f8 01          	cmp    $0x1,%ax
80105424:	0f 85 6a ff ff ff    	jne    80105394 <sys_open+0x134>
8010542a:	8b 8d 64 ff ff ff    	mov    -0x9c(%ebp),%ecx
80105430:	85 c9                	test   %ecx,%ecx
80105432:	0f 84 5c ff ff ff    	je     80105394 <sys_open+0x134>
80105438:	e9 12 ff ff ff       	jmp    8010534f <sys_open+0xef>
8010543d:	8d 76 00             	lea    0x0(%esi),%esi
      end_op();
80105440:	e8 8b d9 ff ff       	call   80102dd0 <end_op>
      return -1;
80105445:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010544a:	eb c0                	jmp    8010540c <sys_open+0x1ac>
8010544c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105450 <sys_symlink>:
...
8010545e:	e8 ed f5 ff ff       	call   80104a50 <argstr>
80105463:	83 c4 10             	add    $0x10,%esp
80105466:	85 c0                	test   %eax,%eax
80105468:	0f 88 82 00 00 00    	js     801054f0 <sys_symlink+0xa0>
8010546e:	83 ec 08             	sub    $0x8,%esp
80105471:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105474:	50                   	push   %eax
80105475:	6a 01                	push   $0x1
80105477:	e8 d4 f5 ff ff       	call   80104a50 <argstr>
8010547c:	83 c4 10             	add    $0x10,%esp
8010547f:	85 c0                	test   %eax,%eax
80105481:	78 6d                	js     801054f0 <sys_symlink+0xa0>
    return -1;

  begin_op();
80105483:	e8 d8 d8 ff ff       	call   80102d60 <begin_op>
...
80105492:	ba 04 00 00 00       	mov    $0x4,%edx
80105497:	e8 a4 f6 ff ff       	call   80104b40 <create>
  if(ip == 0){
...
801054a3:	74 44                	je     801054e9 <sys_symlink+0x99>
    end_op();
    return -1;
  }

  // Write target path into inode data blocks (NUL-terminated)
  int len = strlen(target);
801054a5:	83 ec 0c             	sub    $0xc,%esp
801054a8:	ff 75 f0             	pushl  -0x10(%ebp)
801054ab:	e8 20 f4 ff ff       	call   801048d0 <strlen>
  if(len >= MAXPATH)
801054b0:	ba 7f 00 00 00       	mov    $0x7f,%edx
801054b5:	39 d0                	cmp    %edx,%eax
801054b7:	89 d6                	mov    %edx,%esi
801054b9:	0f 4e f0             	cmovle %eax,%esi
    len = MAXPATH - 1;
...
801054c3:	e8 c8 c6 ff ff       	call   80101b90 <writei>
801054c8:	83 c4 20             	add    $0x20,%esp
801054cb:	39 f0                	cmp    %esi,%eax
801054cd:	75 31                	jne    80105500 <sys_symlink+0xb0>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
801054d3:	e8 38 c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
801054d8:	e8 f3 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801054f5:	eb eb                	jmp    801054e2 <sys_symlink+0x92>
...
80105516:	eb ca                	jmp    801054e2 <sys_symlink+0x92>
...
80105534:	e8 17 f5 ff ff       	call   80104a50 <argstr>
...
8010554f:	e8 ec f5 ff ff       	call   80104b40 <create>
...
80105594:	e8 b7 f4 ff ff       	call   80104a50 <argstr>
...
801055a9:	e8 e2 f3 ff ff       	call   80104990 <argint>
  if((argstr(0, &path)) < 0 ||
...
801055be:	e8 cd f3 ff ff       	call   80104990 <argint>
     argint(1, &major) < 0 ||
...
801055de:	e8 5d f5 ff ff       	call   80104b40 <create>
     argint(2, &minor) < 0 ||
...
80105615:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105618:	e8 63 e3 ff ff       	call   80103980 <myproc>
...
8010562d:	e8 1e f4 ff ff       	call   80104a50 <argstr>
...
801056d5:	e8 76 f3 ff ff       	call   80104a50 <argstr>
...
801056f1:	e8 9a f2 ff ff       	call   80104990 <argint>
...
80105710:	e8 bb ef ff ff       	call   801046d0 <memset>
...
8010573a:	e8 c1 f1 ff ff       	call   80104900 <fetchint>
...
80105758:	e8 e3 f1 ff ff       	call   80104940 <fetchstr>
...
8010578f:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
...
801057c1:	e8 1a f2 ff ff       	call   801049e0 <argptr>
...
801057ee:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
801057f0:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105803:	ff 75 e0             	pushl  -0x20(%ebp)
80105806:	e8 e5 b6 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
8010580b:	58                   	pop    %eax
8010580c:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80105823:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105827:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010582a:	e8 51 e1 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010582f:	31 d2                	xor    %edx,%edx
80105831:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105838:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
80105846:	75 f0                	jne    80105838 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105848:	e8 33 e1 ff ff       	call   80103980 <myproc>
8010584d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105854:	00 
80105855:	eb a9                	jmp    80105800 <sys_pipe+0x50>
80105857:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010585e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105860:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105880:	e9 9b e2 ff ff       	jmp    80103b20 <fork>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  exit();
80105896:	e8 65 e5 ff ff       	call   80103e00 <exit>
...
{
  return wait();
801058a0:	e9 8b e6 ff ff       	jmp    80103f30 <wait>
...
801058bc:	e8 cf f0 ff ff       	call   80104990 <argint>
...
801058ce:	e8 fd e8 ff ff       	call   801041d0 <kill>
...
801058f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058f6:	e8 85 e0 ff ff       	call   80103980 <myproc>
...
8010590d:	e8 7e f0 ff ff       	call   80104990 <argint>
...
80105926:	e8 75 e1 ff ff       	call   80103aa0 <growproc>
...
8010595d:	e8 2e f0 ff ff       	call   80104990 <argint>
...
80105970:	68 80 3d 11 80       	push   $0x80113d80
80105975:	e8 96 ec ff ff       	call   80104610 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010597a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010597d:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105993:	68 80 3d 11 80       	push   $0x80113d80
80105998:	68 60 3d 11 80       	push   $0x80113d60
8010599d:	e8 0e e7 ff ff       	call   801040b0 <sleep>
  while(ticks - ticks0 < n){
801059a2:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
801059af:	73 2f                	jae    801059e0 <sys_sleep+0x90>
    if(myproc()->killed){
801059b1:	e8 ca df ff ff       	call   80103980 <myproc>
801059b6:	8b 40 28             	mov    0x28(%eax),%eax
801059b9:	85 c0                	test   %eax,%eax
801059bb:	74 d3                	je     80105990 <sys_sleep+0x40>
      release(&tickslock);
801059bd:	83 ec 0c             	sub    $0xc,%esp
801059c0:	68 80 3d 11 80       	push   $0x80113d80
801059c5:	e8 e6 eb ff ff       	call   801045b0 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059e3:	68 80 3d 11 80       	push   $0x80113d80
801059e8:	e8 c3 eb ff ff       	call   801045b0 <release>
  return 0;
...
80105a04:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a07:	68 80 3d 11 80       	push   $0x80113d80
80105a0c:	e8 ff eb ff ff       	call   80104610 <acquire>
  xticks = ticks;
80105a11:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105a17:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105a1e:	e8 8d eb ff ff       	call   801045b0 <release>
  return xticks;
}
...
80105a3c:	e8 4f ef ff ff       	call   80104990 <argint>
80105a41:	83 c4 10             	add    $0x10,%esp
80105a44:	85 c0                	test   %eax,%eax
80105a46:	78 18                	js     80105a60 <sys_settickets+0x30>
80105a48:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a4b:	85 c0                	test   %eax,%eax
80105a4d:	7e 11                	jle    80105a60 <sys_settickets+0x30>
    return -1;
  myproc()->tickets = n;
80105a4f:	e8 2c df ff ff       	call   80103980 <myproc>
80105a54:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a57:	89 50 14             	mov    %edx,0x14(%eax)
  return 0;
...
80105aa0:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
80105aa7:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105aae:	08 00 00 8e 
80105ab2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105ab9:	80 
80105aba:	c1 ea 10             	shr    $0x10,%edx
80105abd:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105ac4:	80 
  for(i = 0; i < 256; i++)
...
80105acf:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ad2:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105ad7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105ade:	00 00 ef 
  initlock(&tickslock, "time");
80105ae1:	68 3d 7b 10 80       	push   $0x80107b3d
80105ae6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105aeb:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105af1:	c1 e8 10             	shr    $0x10,%eax
80105af4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105afa:	e8 41 e9 ff ff       	call   80104440 <initlock>
}
...
80105b1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b1f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105b64:	ff 24 85 e4 7b 10 80 	jmp    *-0x7fef841c(,%eax,4)
...
80105b83:	e8 f8 dd ff ff       	call   80103980 <myproc>
80105b88:	8b 50 28             	mov    0x28(%eax),%edx
...
80105bb2:	0f 84 b8 00 00 00    	je     80105c70 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bb8:	e8 c3 dd ff ff       	call   80103980 <myproc>
...
80105c10:	e8 4b dd ff ff       	call   80103960 <cpuid>
...
80105c37:	ff 75 e4             	pushl  -0x1c(%ebp)
80105c3a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105c3b:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105c3e:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c41:	56                   	push   %esi
80105c42:	ff 70 10             	pushl  0x10(%eax)
80105c45:	68 a0 7b 10 80       	push   $0x80107ba0
80105c4a:	e8 51 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105c4f:	83 c4 20             	add    $0x20,%esp
80105c52:	e8 29 dd ff ff       	call   80103980 <myproc>
80105c57:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105c74:	0f 85 3e ff ff ff    	jne    80105bb8 <trap+0x78>
    yield();
80105c7a:	e8 e1 e3 ff ff       	call   80104060 <yield>
...
80105c8f:	e8 cc dc ff ff       	call   80103960 <cpuid>
80105c94:	57                   	push   %edi
80105c95:	56                   	push   %esi
80105c96:	50                   	push   %eax
80105c97:	68 48 7b 10 80       	push   $0x80107b48
...
80105ca6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ca9:	e8 d2 dc ff ff       	call   80103980 <myproc>
...
80105cbf:	90                   	nop
    if(myproc()->killed)
80105cc0:	e8 bb dc ff ff       	call   80103980 <myproc>
80105cc5:	8b 70 28             	mov    0x28(%eax),%esi
...
80105cd5:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105cd8:	e8 f3 ed ff ff       	call   80104ad0 <syscall>
    if(myproc()->killed)
80105cdd:	e8 9e dc ff ff       	call   80103980 <myproc>
80105ce2:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105cf3:	5d                   	pop    %ebp
      exit();
80105cf4:	e9 07 e1 ff ff       	jmp    80103e00 <exit>
...
80105d05:	e8 06 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d0a:	e8 71 dc ff ff       	call   80103980 <myproc>
...
80105d25:	e8 e6 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d2a:	e8 51 dc ff ff       	call   80103980 <myproc>
...
80105d50:	68 80 3d 11 80       	push   $0x80113d80
80105d55:	e8 b6 e8 ff ff       	call   80104610 <acquire>
      wakeup(&ticks);
80105d5a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105d61:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105d68:	e8 03 e4 ff ff       	call   80104170 <wakeup>
      release(&tickslock);
80105d6d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105d74:	e8 37 e8 ff ff       	call   801045b0 <release>
...
80105e57:	74 78                	je     80105ed1 <uartinit+0xd1>
  uart = 1;
80105e59:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105e60:	00 00 00 
...
80105e6c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e6f:	bf 64 7c 10 80       	mov    $0x80107c64,%edi
...
80105e89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105e90:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105f57:	6a 00                	push   $0x0
  jmp alltraps
80105f59:	e9 09 fb ff ff       	jmp    80105a67 <alltraps>
...
80105f60:	6a 01                	push   $0x1
  jmp alltraps
80105f62:	e9 00 fb ff ff       	jmp    80105a67 <alltraps>
...
80105f69:	6a 02                	push   $0x2
  jmp alltraps
80105f6b:	e9 f7 fa ff ff       	jmp    80105a67 <alltraps>
...
80105f72:	6a 03                	push   $0x3
  jmp alltraps
80105f74:	e9 ee fa ff ff       	jmp    80105a67 <alltraps>
...
80105f7b:	6a 04                	push   $0x4
  jmp alltraps
80105f7d:	e9 e5 fa ff ff       	jmp    80105a67 <alltraps>
...
80105f84:	6a 05                	push   $0x5
  jmp alltraps
80105f86:	e9 dc fa ff ff       	jmp    80105a67 <alltraps>
...
80105f8d:	6a 06                	push   $0x6
  jmp alltraps
80105f8f:	e9 d3 fa ff ff       	jmp    80105a67 <alltraps>
...
80105f96:	6a 07                	push   $0x7
  jmp alltraps
80105f98:	e9 ca fa ff ff       	jmp    80105a67 <alltraps>
...
80105f9d:	6a 08                	push   $0x8
  jmp alltraps
80105f9f:	e9 c3 fa ff ff       	jmp    80105a67 <alltraps>
...
80105fb4:	6a 0b                	push   $0xb
  jmp alltraps
80105fb6:	e9 ac fa ff ff       	jmp    80105a67 <alltraps>
...
80105fbb:	6a 0c                	push   $0xc
  jmp alltraps
80105fbd:	e9 a5 fa ff ff       	jmp    80105a67 <alltraps>
...
80105fc2:	6a 0d                	push   $0xd
  jmp alltraps
80105fc4:	e9 9e fa ff ff       	jmp    80105a67 <alltraps>
...
80105fc9:	6a 0e                	push   $0xe
  jmp alltraps
80105fcb:	e9 97 fa ff ff       	jmp    80105a67 <alltraps>
...
80105fd2:	6a 0f                	push   $0xf
  jmp alltraps
80105fd4:	e9 8e fa ff ff       	jmp    80105a67 <alltraps>
...
80105fdb:	6a 10                	push   $0x10
  jmp alltraps
80105fdd:	e9 85 fa ff ff       	jmp    80105a67 <alltraps>
...
80105fe2:	6a 11                	push   $0x11
  jmp alltraps
80105fe4:	e9 7e fa ff ff       	jmp    80105a67 <alltraps>
...
80105feb:	6a 12                	push   $0x12
  jmp alltraps
80105fed:	e9 75 fa ff ff       	jmp    80105a67 <alltraps>
...
80105ff4:	6a 13                	push   $0x13
  jmp alltraps
80105ff6:	e9 6c fa ff ff       	jmp    80105a67 <alltraps>
...
80105ffd:	6a 14                	push   $0x14
  jmp alltraps
80105fff:	e9 63 fa ff ff       	jmp    80105a67 <alltraps>
...
80106006:	6a 15                	push   $0x15
  jmp alltraps
80106008:	e9 5a fa ff ff       	jmp    80105a67 <alltraps>
...
8010600f:	6a 16                	push   $0x16
  jmp alltraps
80106011:	e9 51 fa ff ff       	jmp    80105a67 <alltraps>
...
80106018:	6a 17                	push   $0x17
  jmp alltraps
8010601a:	e9 48 fa ff ff       	jmp    80105a67 <alltraps>
...
80106021:	6a 18                	push   $0x18
  jmp alltraps
80106023:	e9 3f fa ff ff       	jmp    80105a67 <alltraps>
...
8010602a:	6a 19                	push   $0x19
  jmp alltraps
8010602c:	e9 36 fa ff ff       	jmp    80105a67 <alltraps>
...
80106033:	6a 1a                	push   $0x1a
  jmp alltraps
80106035:	e9 2d fa ff ff       	jmp    80105a67 <alltraps>
...
8010603c:	6a 1b                	push   $0x1b
  jmp alltraps
8010603e:	e9 24 fa ff ff       	jmp    80105a67 <alltraps>
...
80106045:	6a 1c                	push   $0x1c
  jmp alltraps
80106047:	e9 1b fa ff ff       	jmp    80105a67 <alltraps>
...
8010604e:	6a 1d                	push   $0x1d
  jmp alltraps
80106050:	e9 12 fa ff ff       	jmp    80105a67 <alltraps>
...
80106057:	6a 1e                	push   $0x1e
  jmp alltraps
80106059:	e9 09 fa ff ff       	jmp    80105a67 <alltraps>
...
80106060:	6a 1f                	push   $0x1f
  jmp alltraps
80106062:	e9 00 fa ff ff       	jmp    80105a67 <alltraps>
...
80106069:	6a 20                	push   $0x20
  jmp alltraps
8010606b:	e9 f7 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106072:	6a 21                	push   $0x21
  jmp alltraps
80106074:	e9 ee f9 ff ff       	jmp    80105a67 <alltraps>
...
8010607b:	6a 22                	push   $0x22
  jmp alltraps
8010607d:	e9 e5 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106084:	6a 23                	push   $0x23
  jmp alltraps
80106086:	e9 dc f9 ff ff       	jmp    80105a67 <alltraps>
...
8010608d:	6a 24                	push   $0x24
  jmp alltraps
8010608f:	e9 d3 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106096:	6a 25                	push   $0x25
  jmp alltraps
80106098:	e9 ca f9 ff ff       	jmp    80105a67 <alltraps>
...
8010609f:	6a 26                	push   $0x26
  jmp alltraps
801060a1:	e9 c1 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060a8:	6a 27                	push   $0x27
  jmp alltraps
801060aa:	e9 b8 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060b1:	6a 28                	push   $0x28
  jmp alltraps
801060b3:	e9 af f9 ff ff       	jmp    80105a67 <alltraps>
...
801060ba:	6a 29                	push   $0x29
  jmp alltraps
801060bc:	e9 a6 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060c3:	6a 2a                	push   $0x2a
  jmp alltraps
801060c5:	e9 9d f9 ff ff       	jmp    80105a67 <alltraps>
...
801060cc:	6a 2b                	push   $0x2b
  jmp alltraps
801060ce:	e9 94 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060d5:	6a 2c                	push   $0x2c
  jmp alltraps
801060d7:	e9 8b f9 ff ff       	jmp    80105a67 <alltraps>
...
801060de:	6a 2d                	push   $0x2d
  jmp alltraps
801060e0:	e9 82 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060e7:	6a 2e                	push   $0x2e
  jmp alltraps
801060e9:	e9 79 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060f0:	6a 2f                	push   $0x2f
  jmp alltraps
801060f2:	e9 70 f9 ff ff       	jmp    80105a67 <alltraps>
...
801060f9:	6a 30                	push   $0x30
  jmp alltraps
801060fb:	e9 67 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106102:	6a 31                	push   $0x31
  jmp alltraps
80106104:	e9 5e f9 ff ff       	jmp    80105a67 <alltraps>
...
8010610b:	6a 32                	push   $0x32
  jmp alltraps
8010610d:	e9 55 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106114:	6a 33                	push   $0x33
  jmp alltraps
80106116:	e9 4c f9 ff ff       	jmp    80105a67 <alltraps>
...
8010611d:	6a 34                	push   $0x34
  jmp alltraps
8010611f:	e9 43 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106126:	6a 35                	push   $0x35
  jmp alltraps
80106128:	e9 3a f9 ff ff       	jmp    80105a67 <alltraps>
...
8010612f:	6a 36                	push   $0x36
  jmp alltraps
80106131:	e9 31 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106138:	6a 37                	push   $0x37
  jmp alltraps
8010613a:	e9 28 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106141:	6a 38                	push   $0x38
  jmp alltraps
80106143:	e9 1f f9 ff ff       	jmp    80105a67 <alltraps>
...
8010614a:	6a 39                	push   $0x39
  jmp alltraps
8010614c:	e9 16 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106153:	6a 3a                	push   $0x3a
  jmp alltraps
80106155:	e9 0d f9 ff ff       	jmp    80105a67 <alltraps>
...
8010615c:	6a 3b                	push   $0x3b
  jmp alltraps
8010615e:	e9 04 f9 ff ff       	jmp    80105a67 <alltraps>
...
80106165:	6a 3c                	push   $0x3c
  jmp alltraps
80106167:	e9 fb f8 ff ff       	jmp    80105a67 <alltraps>
...
8010616e:	6a 3d                	push   $0x3d
  jmp alltraps
80106170:	e9 f2 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106177:	6a 3e                	push   $0x3e
  jmp alltraps
80106179:	e9 e9 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106180:	6a 3f                	push   $0x3f
  jmp alltraps
80106182:	e9 e0 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106189:	6a 40                	push   $0x40
  jmp alltraps
8010618b:	e9 d7 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106192:	6a 41                	push   $0x41
  jmp alltraps
80106194:	e9 ce f8 ff ff       	jmp    80105a67 <alltraps>
...
8010619b:	6a 42                	push   $0x42
  jmp alltraps
8010619d:	e9 c5 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061a4:	6a 43                	push   $0x43
  jmp alltraps
801061a6:	e9 bc f8 ff ff       	jmp    80105a67 <alltraps>
...
801061ad:	6a 44                	push   $0x44
  jmp alltraps
801061af:	e9 b3 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061b6:	6a 45                	push   $0x45
  jmp alltraps
801061b8:	e9 aa f8 ff ff       	jmp    80105a67 <alltraps>
...
801061bf:	6a 46                	push   $0x46
  jmp alltraps
801061c1:	e9 a1 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061c8:	6a 47                	push   $0x47
  jmp alltraps
801061ca:	e9 98 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061d1:	6a 48                	push   $0x48
  jmp alltraps
801061d3:	e9 8f f8 ff ff       	jmp    80105a67 <alltraps>
...
801061da:	6a 49                	push   $0x49
  jmp alltraps
801061dc:	e9 86 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061e3:	6a 4a                	push   $0x4a
  jmp alltraps
801061e5:	e9 7d f8 ff ff       	jmp    80105a67 <alltraps>
...
801061ec:	6a 4b                	push   $0x4b
  jmp alltraps
801061ee:	e9 74 f8 ff ff       	jmp    80105a67 <alltraps>
...
801061f5:	6a 4c                	push   $0x4c
  jmp alltraps
801061f7:	e9 6b f8 ff ff       	jmp    80105a67 <alltraps>
...
801061fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106200:	e9 62 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106207:	6a 4e                	push   $0x4e
  jmp alltraps
80106209:	e9 59 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106210:	6a 4f                	push   $0x4f
  jmp alltraps
80106212:	e9 50 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106219:	6a 50                	push   $0x50
  jmp alltraps
8010621b:	e9 47 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106222:	6a 51                	push   $0x51
  jmp alltraps
80106224:	e9 3e f8 ff ff       	jmp    80105a67 <alltraps>
...
8010622b:	6a 52                	push   $0x52
  jmp alltraps
8010622d:	e9 35 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106234:	6a 53                	push   $0x53
  jmp alltraps
80106236:	e9 2c f8 ff ff       	jmp    80105a67 <alltraps>
...
8010623d:	6a 54                	push   $0x54
  jmp alltraps
8010623f:	e9 23 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106246:	6a 55                	push   $0x55
  jmp alltraps
80106248:	e9 1a f8 ff ff       	jmp    80105a67 <alltraps>
...
8010624f:	6a 56                	push   $0x56
  jmp alltraps
80106251:	e9 11 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106258:	6a 57                	push   $0x57
  jmp alltraps
8010625a:	e9 08 f8 ff ff       	jmp    80105a67 <alltraps>
...
80106261:	6a 58                	push   $0x58
  jmp alltraps
80106263:	e9 ff f7 ff ff       	jmp    80105a67 <alltraps>
...
8010626a:	6a 59                	push   $0x59
  jmp alltraps
8010626c:	e9 f6 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106273:	6a 5a                	push   $0x5a
  jmp alltraps
80106275:	e9 ed f7 ff ff       	jmp    80105a67 <alltraps>
...
8010627c:	6a 5b                	push   $0x5b
  jmp alltraps
8010627e:	e9 e4 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106285:	6a 5c                	push   $0x5c
  jmp alltraps
80106287:	e9 db f7 ff ff       	jmp    80105a67 <alltraps>
...
8010628e:	6a 5d                	push   $0x5d
  jmp alltraps
80106290:	e9 d2 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106297:	6a 5e                	push   $0x5e
  jmp alltraps
80106299:	e9 c9 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062a0:	6a 5f                	push   $0x5f
  jmp alltraps
801062a2:	e9 c0 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062a9:	6a 60                	push   $0x60
  jmp alltraps
801062ab:	e9 b7 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062b2:	6a 61                	push   $0x61
  jmp alltraps
801062b4:	e9 ae f7 ff ff       	jmp    80105a67 <alltraps>
...
801062bb:	6a 62                	push   $0x62
  jmp alltraps
801062bd:	e9 a5 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062c4:	6a 63                	push   $0x63
  jmp alltraps
801062c6:	e9 9c f7 ff ff       	jmp    80105a67 <alltraps>
...
801062cd:	6a 64                	push   $0x64
  jmp alltraps
801062cf:	e9 93 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062d6:	6a 65                	push   $0x65
  jmp alltraps
801062d8:	e9 8a f7 ff ff       	jmp    80105a67 <alltraps>
...
801062df:	6a 66                	push   $0x66
  jmp alltraps
801062e1:	e9 81 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062e8:	6a 67                	push   $0x67
  jmp alltraps
801062ea:	e9 78 f7 ff ff       	jmp    80105a67 <alltraps>
...
801062f1:	6a 68                	push   $0x68
  jmp alltraps
801062f3:	e9 6f f7 ff ff       	jmp    80105a67 <alltraps>
...
801062fa:	6a 69                	push   $0x69
  jmp alltraps
801062fc:	e9 66 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106303:	6a 6a                	push   $0x6a
  jmp alltraps
80106305:	e9 5d f7 ff ff       	jmp    80105a67 <alltraps>
...
8010630c:	6a 6b                	push   $0x6b
  jmp alltraps
8010630e:	e9 54 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106315:	6a 6c                	push   $0x6c
  jmp alltraps
80106317:	e9 4b f7 ff ff       	jmp    80105a67 <alltraps>
...
8010631e:	6a 6d                	push   $0x6d
  jmp alltraps
80106320:	e9 42 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106327:	6a 6e                	push   $0x6e
  jmp alltraps
80106329:	e9 39 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106330:	6a 6f                	push   $0x6f
  jmp alltraps
80106332:	e9 30 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106339:	6a 70                	push   $0x70
  jmp alltraps
8010633b:	e9 27 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106342:	6a 71                	push   $0x71
  jmp alltraps
80106344:	e9 1e f7 ff ff       	jmp    80105a67 <alltraps>
...
8010634b:	6a 72                	push   $0x72
  jmp alltraps
8010634d:	e9 15 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106354:	6a 73                	push   $0x73
  jmp alltraps
80106356:	e9 0c f7 ff ff       	jmp    80105a67 <alltraps>
...
8010635d:	6a 74                	push   $0x74
  jmp alltraps
8010635f:	e9 03 f7 ff ff       	jmp    80105a67 <alltraps>
...
80106366:	6a 75                	push   $0x75
  jmp alltraps
80106368:	e9 fa f6 ff ff       	jmp    80105a67 <alltraps>
...
8010636f:	6a 76                	push   $0x76
  jmp alltraps
80106371:	e9 f1 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106378:	6a 77                	push   $0x77
  jmp alltraps
8010637a:	e9 e8 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106381:	6a 78                	push   $0x78
  jmp alltraps
80106383:	e9 df f6 ff ff       	jmp    80105a67 <alltraps>
...
8010638a:	6a 79                	push   $0x79
  jmp alltraps
8010638c:	e9 d6 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106393:	6a 7a                	push   $0x7a
  jmp alltraps
80106395:	e9 cd f6 ff ff       	jmp    80105a67 <alltraps>
...
8010639c:	6a 7b                	push   $0x7b
  jmp alltraps
8010639e:	e9 c4 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063a5:	6a 7c                	push   $0x7c
  jmp alltraps
801063a7:	e9 bb f6 ff ff       	jmp    80105a67 <alltraps>
...
801063ae:	6a 7d                	push   $0x7d
  jmp alltraps
801063b0:	e9 b2 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063b7:	6a 7e                	push   $0x7e
  jmp alltraps
801063b9:	e9 a9 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063c0:	6a 7f                	push   $0x7f
  jmp alltraps
801063c2:	e9 a0 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801063ce:	e9 94 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063da:	e9 88 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063e6:	e9 7c f6 ff ff       	jmp    80105a67 <alltraps>
...
801063ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063f2:	e9 70 f6 ff ff       	jmp    80105a67 <alltraps>
...
801063f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063fe:	e9 64 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106405:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010640a:	e9 58 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106411:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106416:	e9 4c f6 ff ff       	jmp    80105a67 <alltraps>
...
8010641d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106422:	e9 40 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106429:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010642e:	e9 34 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106435:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010643a:	e9 28 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106441:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106446:	e9 1c f6 ff ff       	jmp    80105a67 <alltraps>
...
8010644d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106452:	e9 10 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106459:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010645e:	e9 04 f6 ff ff       	jmp    80105a67 <alltraps>
...
80106465:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010646a:	e9 f8 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106471:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106476:	e9 ec f5 ff ff       	jmp    80105a67 <alltraps>
...
8010647d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106482:	e9 e0 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106489:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010648e:	e9 d4 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106495:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010649a:	e9 c8 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801064a6:	e9 bc f5 ff ff       	jmp    80105a67 <alltraps>
...
801064ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801064b2:	e9 b0 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801064be:	e9 a4 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801064ca:	e9 98 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064d6:	e9 8c f5 ff ff       	jmp    80105a67 <alltraps>
...
801064dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064e2:	e9 80 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064ee:	e9 74 f5 ff ff       	jmp    80105a67 <alltraps>
...
801064f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064fa:	e9 68 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106501:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106506:	e9 5c f5 ff ff       	jmp    80105a67 <alltraps>
...
8010650d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106512:	e9 50 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106519:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010651e:	e9 44 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106525:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010652a:	e9 38 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106531:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106536:	e9 2c f5 ff ff       	jmp    80105a67 <alltraps>
...
8010653d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106542:	e9 20 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106549:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010654e:	e9 14 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106555:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010655a:	e9 08 f5 ff ff       	jmp    80105a67 <alltraps>
...
80106561:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106566:	e9 fc f4 ff ff       	jmp    80105a67 <alltraps>
...
8010656d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106572:	e9 f0 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106579:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010657e:	e9 e4 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106585:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010658a:	e9 d8 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106591:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106596:	e9 cc f4 ff ff       	jmp    80105a67 <alltraps>
...
8010659d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801065a2:	e9 c0 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801065ae:	e9 b4 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801065ba:	e9 a8 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801065c6:	e9 9c f4 ff ff       	jmp    80105a67 <alltraps>
...
801065cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065d2:	e9 90 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065de:	e9 84 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ea:	e9 78 f4 ff ff       	jmp    80105a67 <alltraps>
...
801065f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065f6:	e9 6c f4 ff ff       	jmp    80105a67 <alltraps>
...
801065fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106602:	e9 60 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106609:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010660e:	e9 54 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106615:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010661a:	e9 48 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106621:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106626:	e9 3c f4 ff ff       	jmp    80105a67 <alltraps>
...
8010662d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106632:	e9 30 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106639:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010663e:	e9 24 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106645:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010664a:	e9 18 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106651:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106656:	e9 0c f4 ff ff       	jmp    80105a67 <alltraps>
...
8010665d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106662:	e9 00 f4 ff ff       	jmp    80105a67 <alltraps>
...
80106669:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010666e:	e9 f4 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106675:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010667a:	e9 e8 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106681:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106686:	e9 dc f3 ff ff       	jmp    80105a67 <alltraps>
...
8010668d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106692:	e9 d0 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106699:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010669e:	e9 c4 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801066aa:	e9 b8 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801066b6:	e9 ac f3 ff ff       	jmp    80105a67 <alltraps>
...
801066bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801066c2:	e9 a0 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801066ce:	e9 94 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066da:	e9 88 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066e6:	e9 7c f3 ff ff       	jmp    80105a67 <alltraps>
...
801066ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066f2:	e9 70 f3 ff ff       	jmp    80105a67 <alltraps>
...
801066f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066fe:	e9 64 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106705:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010670a:	e9 58 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106711:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106716:	e9 4c f3 ff ff       	jmp    80105a67 <alltraps>
...
8010671d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106722:	e9 40 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106729:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010672e:	e9 34 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106735:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010673a:	e9 28 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106741:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106746:	e9 1c f3 ff ff       	jmp    80105a67 <alltraps>
...
8010674d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106752:	e9 10 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106759:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010675e:	e9 04 f3 ff ff       	jmp    80105a67 <alltraps>
...
80106765:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010676a:	e9 f8 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106771:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106776:	e9 ec f2 ff ff       	jmp    80105a67 <alltraps>
...
8010677d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106782:	e9 e0 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106789:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010678e:	e9 d4 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106795:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010679a:	e9 c8 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801067a6:	e9 bc f2 ff ff       	jmp    80105a67 <alltraps>
...
801067ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801067b2:	e9 b0 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801067be:	e9 a4 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801067ca:	e9 98 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067d6:	e9 8c f2 ff ff       	jmp    80105a67 <alltraps>
...
801067dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067e2:	e9 80 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067ee:	e9 74 f2 ff ff       	jmp    80105a67 <alltraps>
...
801067f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067fa:	e9 68 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106801:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106806:	e9 5c f2 ff ff       	jmp    80105a67 <alltraps>
...
8010680d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106812:	e9 50 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106819:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010681e:	e9 44 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106825:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010682a:	e9 38 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106831:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106836:	e9 2c f2 ff ff       	jmp    80105a67 <alltraps>
...
8010683d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106842:	e9 20 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106849:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010684e:	e9 14 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106855:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010685a:	e9 08 f2 ff ff       	jmp    80105a67 <alltraps>
...
80106861:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106866:	e9 fc f1 ff ff       	jmp    80105a67 <alltraps>
...
8010686d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106872:	e9 f0 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106879:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010687e:	e9 e4 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106885:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010688a:	e9 d8 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106891:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106896:	e9 cc f1 ff ff       	jmp    80105a67 <alltraps>
...
8010689d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801068a2:	e9 c0 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801068ae:	e9 b4 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801068ba:	e9 a8 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801068c6:	e9 9c f1 ff ff       	jmp    80105a67 <alltraps>
...
801068cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068d2:	e9 90 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068de:	e9 84 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ea:	e9 78 f1 ff ff       	jmp    80105a67 <alltraps>
...
801068f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068f6:	e9 6c f1 ff ff       	jmp    80105a67 <alltraps>
...
801068fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106902:	e9 60 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106909:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010690e:	e9 54 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106915:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010691a:	e9 48 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106921:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106926:	e9 3c f1 ff ff       	jmp    80105a67 <alltraps>
...
8010692d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106932:	e9 30 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106939:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010693e:	e9 24 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106945:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010694a:	e9 18 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106951:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106956:	e9 0c f1 ff ff       	jmp    80105a67 <alltraps>
...
8010695d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106962:	e9 00 f1 ff ff       	jmp    80105a67 <alltraps>
...
80106969:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010696e:	e9 f4 f0 ff ff       	jmp    80105a67 <alltraps>
...
80106975:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010697a:	e9 e8 f0 ff ff       	jmp    80105a67 <alltraps>
...
80106981:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106986:	e9 dc f0 ff ff       	jmp    80105a67 <alltraps>
...
8010698d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106992:	e9 d0 f0 ff ff       	jmp    80105a67 <alltraps>
...
80106999:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010699e:	e9 c4 f0 ff ff       	jmp    80105a67 <alltraps>
...
801069a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801069aa:	e9 b8 f0 ff ff       	jmp    80105a67 <alltraps>
...
801069b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801069b6:	e9 ac f0 ff ff       	jmp    80105a67 <alltraps>
...
801069bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801069c2:	e9 a0 f0 ff ff       	jmp    80105a67 <alltraps>
...
80106b15:	e8 b6 db ff ff       	call   801046d0 <memset>
...
80106b5d:	68 6c 7c 10 80       	push   $0x80107c6c
...
80106b73:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b76:	e8 e5 cd ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106c00:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106c34:	0f 84 c2 00 00 00    	je     80106cfc <switchuvm+0xec>
  pushcli();
80106c3a:	e8 81 d8 ff ff       	call   801044c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c3f:	e8 bc cc ff ff       	call   80103900 <mycpu>
80106c44:	89 c3                	mov    %eax,%ebx
80106c46:	e8 b5 cc ff ff       	call   80103900 <mycpu>
80106c4b:	89 c7                	mov    %eax,%edi
80106c4d:	e8 ae cc ff ff       	call   80103900 <mycpu>
80106c52:	83 c7 08             	add    $0x8,%edi
80106c55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c58:	e8 a3 cc ff ff       	call   80103900 <mycpu>
...
80106cc4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106cc7:	e8 34 cc ff ff       	call   80103900 <mycpu>
...
80106d4f:	e8 7c d9 ff ff       	call   801046d0 <memset>
...
80106d82:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d83:	e9 e8 d9 ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
80106d88:	83 ec 0c             	sub    $0xc,%esp
80106d8b:	68 b1 7c 10 80       	push   $0x80107cb1
...
80106df0:	68 cb 7c 10 80       	push   $0x80107ccb
...
80106e3b:	ff 75 10             	pushl  0x10(%ebp)
...
80106e78:	68 6c 7d 10 80       	push   $0x80107d6c
...
80106edb:	e8 f0 d7 ff ff       	call   801046d0 <memset>
...
80106f19:	68 e9 7c 10 80       	push   $0x80107ce9
...
80106f7b:	68 01 7d 10 80       	push   $0x80107d01
...
8010705c:	68 1d 7d 10 80       	push   $0x80107d1d
...
80107090:	e8 3b d6 ff ff       	call   801046d0 <memset>
...
801070fb:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010712c:	68 2e 7d 10 80       	push   $0x80107d2e
...
801071a2:	68 38 7d 10 80       	push   $0x80107d38
...
80107200:	e8 6b d5 ff ff       	call   80104770 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107205:	58                   	pop    %eax
80107206:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010720c:	5a                   	pop    %edx
8010720d:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80107277:	68 52 7d 10 80       	push   $0x80107d52
...
80107330:	e8 3b d4 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
