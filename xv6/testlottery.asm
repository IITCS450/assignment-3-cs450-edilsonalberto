...
int main(int argc, char **argv){
  ...
  if(argc == 2) t = atoi(argv[1]);
  15:	0f 84 7d 00 00 00    	je     98 <main+0x98>

  if(settickets(0) == 0){
  1b:	83 ec 0c             	sub    $0xc,%esp
  int t = 10;
  1e:	bb 0a 00 00 00       	mov    $0xa,%ebx
  if(settickets(0) == 0){
  23:	6a 00                	push   $0x0
  25:	e8 b9 03 00 00       	call   3e3 <settickets>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	0f 84 83 00 00 00    	je     b8 <main+0xb8>
  ...
  38:	53                   	push   %ebx
  39:	e8 a5 03 00 00       	call   3e3 <settickets>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	85 c0                	test   %eax,%eax
  43:	0f 85 8f 00 00 00    	jne    d8 <main+0xd8>
  ...
  49:	52                   	push   %edx
  4a:	52                   	push   %edx
  4b:	68 11 08 00 00       	push   $0x811
  50:	6a 01                	push   $0x1
  52:	e8 49 04 00 00       	call   4a0 <printf>
  57:	83 c4 10             	add    $0x10,%esp
  5a:	b9 c8 00 00 00       	mov    $0xc8,%ecx
  5f:	90                   	nop
static void burn(int n){ for(int i=0;i<n;i++) sink += i; }
  60:	31 c0                	xor    %eax,%eax
  62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  68:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
  6e:	01 c2                	add    %eax,%edx
  70:	83 c0 01             	add    $0x1,%eax
  73:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
  79:	3d 40 0d 03 00       	cmp    $0x30d40,%eax
  7e:	75 e8                	jne    68 <main+0x68>

  for(int k=0;k<200;k++) burn(200000);
  80:	83 e9 01             	sub    $0x1,%ecx
  83:	75 db                	jne    60 <main+0x60>
  printf(1, "testlottery: done\n");
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	68 2e 08 00 00       	push   $0x82e
  8c:	6a 01                	push   $0x1
  8e:	e8 0d 04 00 00       	call   4a0 <printf>
  exit();
  93:	e8 ab 02 00 00       	call   343 <exit>
  if(argc == 2) t = atoi(argv[1]);
  98:	83 ec 0c             	sub    $0xc,%esp
  9b:	ff 70 04             	pushl  0x4(%eax)
  9e:	e8 2d 02 00 00       	call   2d0 <atoi>
  if(settickets(0) == 0){
  a3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  if(argc == 2) t = atoi(argv[1]);
  aa:	89 c3                	mov    %eax,%ebx
  if(settickets(0) == 0){
  ac:	e8 32 03 00 00       	call   3e3 <settickets>
  b1:	83 c4 10             	add    $0x10,%esp
  b4:	85 c0                	test   %eax,%eax
  b6:	75 13                	jne    cb <main+0xcb>
    printf(1, "FAIL: settickets(0) should fail\n");
  b8:	53                   	push   %ebx
  b9:	53                   	push   %ebx
  ba:	68 c8 07 00 00       	push   $0x7c8
  bf:	6a 01                	push   $0x1
  c1:	e8 da 03 00 00       	call   4a0 <printf>
    exit();
  c6:	e8 78 02 00 00       	call   343 <exit>
  if(t >= 1 && settickets(t) != 0){
  cb:	85 db                	test   %ebx,%ebx
  cd:	0f 8e 76 ff ff ff    	jle    49 <main+0x49>
  d3:	e9 5d ff ff ff       	jmp    35 <main+0x35>
    printf(1, "FAIL: settickets(%d) should succeed\n", t);
  d8:	51                   	push   %ecx
  d9:	53                   	push   %ebx
  da:	68 ec 07 00 00       	push   $0x7ec
  df:	6a 01                	push   $0x1
  e1:	e8 ba 03 00 00       	call   4a0 <printf>
    exit();
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 48 08 00 00 	jmp    *0x848(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 41 08 00 00       	mov    $0x841,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 50 0b 00 00    	mov    %edx,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 50 0b 00 00    	mov    0xb50,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 50 0b 00 00    	mov    0xb50,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 54 0b 00 00       	mov    $0xb54,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 7b2:	00 00 00 
    if(p->s.size >= nunits){
